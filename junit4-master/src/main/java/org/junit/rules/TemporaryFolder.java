 ...
 * deleted when the test method finishes (whether it passes or fails). By
 * default no exception will be thrown in case the deletion fails.
 *
 * <p>
 * Example of usage:
 * 
 ...
 *
 * <p>
 * TemporaryFolder rule supports assured deletion mode, which will fail the test
 * in case deletion fails with {@link AssertionError}.
 *
 * <p>
 ...
 * <pre>
 * &#064;Rule
 * public TemporaryFolder folder = TemporaryFolder.builder().assureDeletion()
 *         .build();
 * </pre>
 *
 * @since 4.7
...
public class TemporaryFolder extends ExternalResource {
     ...
     *            {@code null} then system default temporary-file directory is
     *            used.
     */
    ...
    /**
     * Create a {@link TemporaryFolder} initialized with values from a builder.
     */
    ...
    public static class Builder {
        ...
        /**
         * Specifies which folder to use for creating temporary resources. If
         * {@code null} then system default temporary-file directory is used.
         *
         * @return this
         */
         ...
         * Failure to fulfill the assurance results in failure of tests with an
         * {@link AssertionError}.
         *
         * @return this
         */
        ...
        /**
         * Builds a {@link TemporaryFolder} instance using the values in this
         * builder.
         */
    ...
    private File createTemporaryFolderIn(File parentFolder) throws IOException {
        ...
        for (int i = 0; i < TEMP_DIR_ATTEMPTS; ++i) {
            ...
            String suffix = ".tmp";
            File tmpFile = File.createTempFile(TMP_PREFIX, suffix,
                    parentFolder);
            String tmpName = tmpFile.toString();
            // Discard .tmp suffix of tmpName.
            String folderName = tmpName.substring(0,
                    tmpName.length() - suffix.length());
        ...
        if (createdFolder != null)
            throw new IOException("Unable to create temporary directory in: "
                    + parentFolder.toString() + ". Tried " + TEMP_DIR_ATTEMPTS
                    + " times. " + "Last attempted to create: "
     ...
     *             if unable to clean up resources and deletion of resources is
     *             assured.
     */
    public void delete() {
        if (!tryDelete()) {
